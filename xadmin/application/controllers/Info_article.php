...
class Info_article extends Info
{
    ...
    public function set_url()
    {
        ...
        $url['del_btn'] = $this->auth->set(config_item('my_del'), $this->sys_menu_auth, '<a class="btn btn-danger btn-sm batch-del-hook" href="javascript:;" data-tb="info_article" data-menu="' . $this->main_section_name . '" data-url = "' . site_url('api/batch_del?cid=' . $this->cid) . '">删除</a>');
