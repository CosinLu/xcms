...
class Info extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->children_cid = $this->tree->get_children($this->info_model->data(), $this->cid, TRUE, 'id');
        $this->main_sidebar();
    }
    ...
    public function main_sidebar()
    {
        ...
        $info_category_res = $this->db->get()->result_array();
        $info_category_sort = $this->tree->serialize($info_category_res);
        $str = '<div class="ph pt iframe_main_sidebar_btn_group"><a href="' . site_url('info_category/insert') . '" class="btn btn-primary btn-block">新增栏目</a></div>';
        ...
        foreach ($info_category_sort as $val) {
            $level = $val['level'];
    ...
    {
        $res = $this->info_model->model_id($this->cid);
