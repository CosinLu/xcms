...
class Info_news extends Information
{
    ...
    public function save()
    {
        ...
        if ($bool) {
            switch ($this->is_save) {
                case '1':
                    $this->prompt->success('操作成功！', site_url('info_news?sys_cid=' . $this->sys_cid . '&cid=' . $this->cid));
                    break;
                case '2':
            ...
            $this->prompt->error('操作失败！', site_url('info_news?sys_cid=' . $this->sys_cid . '&cid=' . $this->cid));
        }
    }
