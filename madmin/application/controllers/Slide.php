...
class Slide extends MY_Controller
{
    ...
    public function set_url()
    {
        ...
        $url['insert_btn'] = '<a class="btn btn-primary" href="' . site_url('slide/insert?sys_cid=' . $this->sys_cid) . '">新增</a>';
        $url['del_btn'] = '<a class="btn btn-default" href="javascript:;" data-name="batchDel" data-tb="slide" data-checkname="id" data-url = "' . site_url('ajax/batch_del?sys_cid=' . $this->sys_cid) . '">删除</a>';
    ...
    public function get_list()
    {
        ...
        foreach ($data['list']['list'] as $key => $val) {
            $data['list']['list'][$key]['update_btn'] = '<a href="' . site_url('slide/update?sys_cid=' . $this->sys_cid . '&id=' . $val['id']) . '">编辑</a>';
            $data['list']['list'][$key]['del_btn'] = '<a href="javascript:;" data-name="del" data-tb="slide" data-id="' . $val['id'] . '" data-url="' . site_url('ajax/del') . '">删除</a>';
        }
