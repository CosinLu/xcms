...
class Category
{
     ...
     * @param int $sys_tpl_id 模板类型标识
     * @return string
     */
    /*public function insert_ddl($name = '', $id = 0, $data = array(), $root = TRUE, $sys_tpl_id = '')
    {
        $str = '';
        ...
        foreach ($data as $val) {
            ...
            $disabled = '';
            if (!empty($sys_tpl_id)) {
                $disabled = ($val['sys_tpl_id'] != $sys_tpl_id) ? 'disabled' : '';
            }
     ...
     * @return string
     */
    /*public function update_ddl($name = '', $id = 0, $pid = 0, $data = array(), $root = TRUE, $sys_tpl_id = '')
    {
        $str = '';
        $str .= '<select name="' . $name . '" class="form-control">';
        $start_level = 1;
     ...
     * @return string
     */
    public function ddl($name = '', $id = 0, $pid = 0, $data = array(), $root = TRUE, $sys_tpl_id = '')
    {
        $str = '';
        $str .= '<select name="' . $name . '" class="form-control">';
        $start_level = 1;
