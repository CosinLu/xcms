...
(function (root, factory) {
    ...
    define('widgets/filepicker', [
        ...
        $.extend(Uploader.options, {
             ...
             *     mimeTypes: 'image/jpeg,image/pjpeg,image/png,image/x-png,image/gif,image/bmp,image/x-bmp,image/x-bitmap,image/x-xbitmap,image/x-win-bitmap,image/x-windows-bmp,image/ms-bmp,image/x-ms-bmp,application/bmp,application/x-bmp,application/x-win-bitmap,image/bmp,image/x-bmp,image/x-bitmap,image/x-xbitmap,image/x-win-bitmap,image/x-windows-bmp,image/ms-bmp,image/x-ms-bmp,application/bmp,application/x-bmp,application/x-win-bitmap'
             * }
             * ```
             */
            accept: null/*{
