...
INSERT INTO `common_dict` VALUES ('10', '显示', '9', '2', 'show', null, '#5cb85c', '0', '100');
INSERT INTO `common_dict` VALUES ('11', '隐藏', '9', '2', 'hide', null, '#d9534f', '0', '100');
...
INSERT INTO `sys_login_log` VALUES ('10', '4', '::1', '1508826958');
...
CREATE TABLE `sys_menu` (
  ...
  `sort` int(10) DEFAULT '100',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='系统菜单表';
...
CREATE TABLE `sys_oplog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='系统操作日志表';
...
INSERT INTO `sys_oplog` VALUES ('5', '4', 'xadmin', '菜单管理', 'insert', 'success', 'Chrome', '62.0.3202.62', 'Windows 10', 'DESKTOP-PRO736K', '::1', '1508827987');
INSERT INTO `sys_oplog` VALUES ('6', '4', 'xadmin', '菜单管理', 'del', 'success', 'Chrome', '62.0.3202.62', 'Windows 10', 'DESKTOP-PRO736K', '::1', '1508828005');
